...
namespace PracP3_Task3
{
    public partial class Form1 : Form
    {
        ...
        /// <summary>
        /// Adds tree where left clicked shrub when right clicked
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void pictureBox1_MouseClick(object sender, MouseEventArgs e)
        {
            try 
            {
                ...
                {
                    //add tree to list where left clicked
                ...
                {
                    //add shrub to list where right clicked
                    forest.AddShrub(e.X, e.Y, int.Parse(textBoxFoliage.Text));
                }
            }
            catch (Exception ex)
            {
        ...
        private void generateReportToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                string filename = saveFileDialog1.FileName;
                forest.GenerateReport(filename);
            }
        }
    }
}
