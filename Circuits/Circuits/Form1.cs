...
namespace Circuits
{
    //Samuel Lee and Xenith

    //answers to questions
    //1. The gate class yes you can inherit comments
    
    //2. you are forced to override it so it has to be used in each subclass
    //so you can't forget about it. If you have a subclass that doesnt need it then you must make an empty 
    //version in the class plus might end up repeating code

    //3.yes

    //4. It should just use add the compound gate as part of the group. Hopfully yes.
    ...
    public partial class Form1 : Form
    {
        ...
        /// <summary>
        /// is gate being added to compound gate
        /// </summary>
        protected Compound newCompound;
        ...
        private void Form1_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            if (newGate != null)
            {
                ...
                newGate = null;
                this.Invalidate();
            }//if start compound group is clicked
            else if (startGroup)
            {
                //loop through gate and selects each gate
        ...
        /// <summary>
        /// This will create a or and gate.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// This will create a not and gate.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// This will create a new output source.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        private void toolStripButtonClone_Click(object sender, EventArgs e)
        {
            try
            {
                //loop through gates to see whats selected
                foreach (Gate gate in gatesList)
                {
                    //copy gate and add to list
                    Gate newGate = gate.Clone(50,50);
                    // check if its the selected gate
                    if (newGate != null)
                    {
                        gatesList.Add(newGate);
                    }
        ...
        /// <summary>
        /// creates group of compound gates
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        {//start new group
            startGroup = true;
            //make all selected gates not selected
             foreach (Gate Gate in gatesList)
             {
                Gate.Selected = false;
             }
             //redraw graphics
            this.Invalidate();
            //make new compound gate
            newCompound = new Compound( 10, 10);


        }

        /// <summary>
        /// ends group and puts into compound gate
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void toolStripButtonEndGroup_Click(object sender, EventArgs e)
        {
            try
            {
                //end gate
                startGroup = false;
                //loop through each gate and if selected add them to compound gate
                foreach (Gate Gate in gatesList)
                {
                    if (Gate.Selected)
                    {
